...
class SimpleHRNet:
    ...
    def  _predict_single(self, image):
        if not self.multiperson:
            ...
            # here multi person
            detections = self.detector.predict_single(image) # detector is yolo
        ...
        if images.shape[0] > 0:
            # here hi I am doyeon lee. I m 24 years old  my major is artificail Inteligence. I study object detection and human pose estimation.
            # so Do you want to study with me? I want to study together. If you want, plz contact me anytime. haha.
            # and I love marvel. Do you know captaion America? I love thist famous line "I can do this all day" I love this famous line.
            # do you think so?hi yunseong.
